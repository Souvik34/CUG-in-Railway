      ...
      <table className="min-w-full mx-auto border-collapse border border-gray-200">
        ...
        <tbody>
          <tr>
            ...
            <td className="px-4 py-2 border border-gray-300 text-left text-sm">74.61 Rs</td>
          </tr>
          <tr>
            <td className="px-4 py-2 border border-gray-300 text-left text-sm">GROUP B</td>
            <td className="px-4 py-2 border border-gray-300 text-left text-sm">59.05 Rs</td>
          </tr>
          <tr>
            <td className="px-4 py-2 border border-gray-300 text-left text-sm">GROUP C</td>
            <td className="px-4 py-2 border border-gray-300 text-left text-sm">39.90 Rs</td>
          </tr>
        </tbody>
      </table>
    </div>
