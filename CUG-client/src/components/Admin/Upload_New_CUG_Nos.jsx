    ...
    <div className="flex flex-col items-center min-h-screen mx-auto my-20">
      <div className="w-full max-w-xl  px-36 py-6 space-y-6 bg-white shadow-md rounded-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            <label htmlFor="file_upload" className="block text-md text-center mb-3 font-semibold  text-gray-700">Upload CSV/Excel</label>
            <input
              type="file"
              id="file_upload"
              className="mt-1 block w-full px-3 py-2 border    border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm  md:text-md lg:text-lg"
          ...
          <div className='flex justify-center'>
            <button type="submit" className="w-40 py-2 px-4    items-center bg-blue-500 hover:bg-blue-700 text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Submit</button>
          </div>
        </form>
      </div>
